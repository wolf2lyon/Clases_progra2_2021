...
void ArrBase_Movimiento::Cambiar_Eliminar(int indice, bool nuevo) { arreglo[indice]->Cambiar_eliminar(nuevo); }
...
bool ArrBase_Movimiento::Retornar_Eliminar(int indice) { return arreglo[indice]->Retornar_eliminar(); }
